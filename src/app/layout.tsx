...
export const metadata: Metadata = {
  title: "The Foundry Salon - New Braunfels Hair Salon",  description: "Expert hair salon in New Braunfels, TX. 4.9★ rated. Haircuts, color, highlights from master stylists. Book online or call (830) 387-4341.",  keywords: "hair salon New Braunfels, haircuts, hair color, highlights, balayage, salon near me, barber, stylist",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "The Foundry Salon - New Braunfels",    description: "Premium hair salon with 1,200+ five-star reviews. Expert stylists, welcoming atmosphere, free beverages.",    siteName: "The Foundry Salon",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/woman-getting-treatment-hairdresser-shop_23-2149230930.jpg",        alt: "The Foundry Salon Interior"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "The Foundry Salon - New Braunfels",    description: "4.9★ rated hair salon. Expert cuts, color & highlights. Open until 8 PM.",    images: ["http://img.b2bpic.net/free-photo/woman-getting-treatment-hairdresser-shop_23-2149230930.jpg"],
  },
};
